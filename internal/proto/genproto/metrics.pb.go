...
// 	protoc        v6.33.1
// source: internal/proto/src/metrics.proto
...
func (Metric_MType) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_proto_src_metrics_proto_enumTypes[0].Descriptor()
}

func (Metric_MType) Type() protoreflect.EnumType {
	return &file_internal_proto_src_metrics_proto_enumTypes[0]
}
...
func (x *Metric) Reset() {
	*x = Metric{}
	mi := &file_internal_proto_src_metrics_proto_msgTypes[0]
...
func (x *UpdateMetricsRequest) Reset() {
	*x = UpdateMetricsRequest{}
	mi := &file_internal_proto_src_metrics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UpdateMetricsResponse) Reset() {
	*x = UpdateMetricsResponse{}
	mi := &file_internal_proto_src_metrics_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_internal_proto_src_metrics_proto protoreflect.FileDescriptor

const file_internal_proto_src_metrics_proto_rawDesc = "" +
	"\n" +
	" internal/proto/src/metrics.proto\x12\ametrics\"\x90\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseBFZDgithub.com/dmitastr/yp_observability_service/internal/proto/genprotob\x06proto3"

var file_internal_proto_src_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_internal_proto_src_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_internal_proto_src_metrics_proto_goTypes = []any{
...
var file_internal_proto_src_metrics_proto_depIdxs = []int32{
...
func init() { file_internal_proto_src_metrics_proto_init() }
func file_internal_proto_src_metrics_proto_init() {
	if File_internal_proto_src_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_proto_src_metrics_proto_rawDesc), len(file_internal_proto_src_metrics_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_proto_src_metrics_proto_goTypes,
		DependencyIndexes: file_internal_proto_src_metrics_proto_depIdxs,
		EnumInfos:         file_internal_proto_src_metrics_proto_enumTypes,
		MessageInfos:      file_internal_proto_src_metrics_proto_msgTypes,
	}.Build()
	File_internal_proto_src_metrics_proto = out.File
	file_internal_proto_src_metrics_proto_goTypes = nil
	file_internal_proto_src_metrics_proto_depIdxs = nil
}
