...
// Source: .\internal\domain\pinger\pinger.go
...
import (
	...
	repository "github.com/dmitastr/yp_observability_service/internal/repository"
...
func (m *MockPinger) Ping(arg0 context.Context, arg1 repository.Database) error {
	m.ctrl.T.Helper()
